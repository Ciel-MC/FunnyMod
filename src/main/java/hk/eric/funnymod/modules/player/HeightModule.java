...
public class HeightModule extends ToggleableModule {
    ...
    public static final BooleanSettingWithSubSettings advancedSettings = new BooleanSettingWithSubSettings("Advanced settings", "OldHeightAdvancedSettings", "Advanced settings",false);
    ...
    private static final TwoDimensionalEnumMap<Version,HeightType, FloatReference> HEIGHTS = TwoDimensionalEnumMap.of(Version.class, HeightType.class,
            new TypedPairList<>(Version.CURRENT,
                    HeightType.NORMAL_HITBOX, new FinalFloatReference(1.8F),
                    HeightType.NORMAL_EYE_HEIGHT, new FinalFloatReference(1.62F),
                    HeightType.SNEAKING_HITBOX, new FinalFloatReference(1.5F),
                    HeightType.SNEAKING_EYE_HEIGHT, new FinalFloatReference(1.27F)
            ),
            new TypedPairList<>(Version.OLD,
                    HeightType.NORMAL_HITBOX, new FinalFloatReference(1.8F),
                    HeightType.NORMAL_EYE_HEIGHT, new FinalFloatReference(1.8F * .85F),
                    HeightType.SNEAKING_HITBOX, new FinalFloatReference(1.65F),
                    HeightType.SNEAKING_EYE_HEIGHT, new FinalFloatReference(1.65F*.85F)
            ),
            new TypedPairList<>(Version.OLDER,
                    HeightType.NORMAL_HITBOX, new FinalFloatReference(1.8F),
                    HeightType.NORMAL_EYE_HEIGHT, new FinalFloatReference(1.62F),
                    HeightType.SNEAKING_HITBOX, new FinalFloatReference(1.8F),
                    HeightType.SNEAKING_EYE_HEIGHT, new FinalFloatReference(1.62F - 0.08F)
            ),
            new TypedPairList<>(Version.Custom,
                    HeightType.NORMAL_HITBOX, new LinkedFloatReferenceImpl(custom_normal_Hitbox::setValue, custom_normal_Hitbox::getValue),
                    HeightType.NORMAL_EYE_HEIGHT, new LinkedFloatReferenceImpl(custom_normal_eye::setValue, custom_normal_eye::getValue),
                    HeightType.SNEAKING_HITBOX, new LinkedFloatReferenceImpl(custom_sneaking_Hitbox::setValue, custom_sneaking_Hitbox::getValue),
                    HeightType.SNEAKING_EYE_HEIGHT, new LinkedFloatReferenceImpl(custom_sneaking_eye::setValue, custom_sneaking_eye::getValue)
            )
    );
