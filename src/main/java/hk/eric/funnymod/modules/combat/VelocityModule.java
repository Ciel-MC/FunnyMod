...
public class VelocityModule extends ToggleableModule {
    ...
    public static final IntegerSetting horizontal = new IntegerSetting("Horizontal","KBHorizontal","Horizontal knockback modifier",-200, 200, 100);
    public static final IntegerSetting vertical = new IntegerSetting("Vertical","KBVertical","Vertical knockback modifier",-200, 200, 100);
