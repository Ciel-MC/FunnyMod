...
public interface IInterface {
	 ...
	 * @see #SUPER
	 */
    boolean getModifier(int modifier);
	 ...
	 */
    void drawString(Point pos, int height, String s, Color c);
	 ...
	 */
    int getFontWidth(int height, String s);
	 ...
	 */
    void fillTriangle(Point pos1, Point pos2, Point pos3, Color c1, Color c2, Color c3);
	 ...
	 */
    void drawLine(Point a, Point b, Color c1, Color c2);
	 ...
	 * @see #loadImage(String)
	 */
    void drawImage(Rectangle r, int rotation, boolean parity, int image, Color color);
