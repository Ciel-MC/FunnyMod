...
public interface IComponentAdder {
	 ...
	 */
    <S extends IComponent,T extends IComponent> void addComponent(S title, T content, ThemeTuple theme, Point position, int width, Supplier<Animation> animation);
	
	/**
	 * Add a pop-up.
	 * @param popup the pop-up to be added
	 */
    void addPopup(IFixedComponent popup);
}
