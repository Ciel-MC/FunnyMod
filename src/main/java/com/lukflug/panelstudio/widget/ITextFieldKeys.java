...
public interface ITextFieldKeys {
	 ...
	 */
    boolean isBackspaceKey(int scancode);
	 ...
	 * @return true, if key matches
	 */
    boolean isDeleteKey(int scancode);
	 ...
	 * @return true, if key matches
	 */
    boolean isInsertKey(int scancode);
	 ...
	 * @return true, if key matches
	 */
    boolean isLeftKey(int scancode);
	 ...
	 * @return true, if key matches
	 */
    boolean isRightKey(int scancode);
	 ...
	 * @return true, if key matches
	 */
    boolean isHomeKey(int scancode);
	 ...
	 * @return true, if key matches
	 */
    boolean isCopyKey(int scancode);
	 ...
	 * @return true, if key matches
	 */
    boolean isPasteKey(int scancode);
