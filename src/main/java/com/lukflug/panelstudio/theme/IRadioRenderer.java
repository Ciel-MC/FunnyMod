...
public interface IRadioRenderer {
	 ...
	 */
	void renderItem(Context context, ILabeled[] items, boolean focus, int target, double state, boolean horizontal);
	 ...
	 */
	int getDefaultHeight(ILabeled[] items, boolean horizontal);
