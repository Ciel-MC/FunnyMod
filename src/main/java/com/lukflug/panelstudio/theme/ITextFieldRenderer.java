...
public interface ITextFieldRenderer {
	 ...
	 */
    int renderTextField(Context context, String title, boolean focus, String content, int position, int select, int boxPosition, boolean insertMode);
	 ...
	 */
    Rectangle getTextArea(Context context, String title);
	 ...
	 */
    int transformToCharPos(Context context, String title, String content, int boxPosition);
}
