...
public interface ITabGUIRenderer<T> {
	 ...
	 */
    void renderTab(Context context, int amount, double tabState);
	 ...
	 */
    void renderItem(Context context, int amount, double tabState, int index, String title, T itemState);
	 ...
	 */
    Rectangle getItemRect(IInterface inter, Rectangle rect, int amount, double tabState);
}
